 ...
 *
 * This file reads the recipies file and then uploads data to elastic search index
 */
...
fs.readFile('server/components/uploads/recipeitems-latest.json', {encoding: 'utf-8'}, function(err, data) {
  if (err) { throw err; }
